<template>
  <div>
    <van-nav-bar title="羊狮幕景区门票" left-text="返回" left-arrow @click-left="onClickLeft" />
    <div class="banner">
    ...
    <div class="ticket">
      <div class="title">
        <h4>羊狮幕景区</h4>
        <p>羊狮慕是位于江西省吉安市安福县武功山的一处自然风景区</p>
      </div>
      <div class="time">
        开园时间：08:00-17:00
      </div>
    ...
    <div class="index">
      ...
      <div class="count">
        <h4>门票份数</h4>
        <van-stepper v-model="userOrder.quantity" theme="round" button-size="22" disable-input class="stepper"
          @change="change()" />
      </div>
      <div class="datatime">
